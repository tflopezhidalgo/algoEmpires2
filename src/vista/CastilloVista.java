...
public class CastilloVista extends StackPane{

	public static int TAMANIO_CASILLA = CasillaVista.TAMANIO_CASILLA;
	
	public CastilloVista(int x, int y) {
		...
		Rectangle rectangulo = new Rectangle(TAMANIO_CASILLA*(4-0.05), TAMANIO_CASILLA*(4-0.05));
