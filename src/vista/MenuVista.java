...
public class MenuVista extends BorderPane {
    ...
    public MenuVista(Stage stagePrincipal){
    	...
    	//--------------- Imagen de fondo -----------------------
        Image background = new Image("resources/image/ElementosMenu/menuBackground3.png");
        ...
        Image imagenComenzar = new Image("resources/image/ElementosMenu/Botones/comenzar3.png");
        ...
        Image imagenSalir = new Image("resources/image/ElementosMenu/Botones/salir3.png");
